...
#     mock_node.question = mock_question
#     mock_node.as_dict.return_value = {"mock_node_data": "mock_value"}
#     mock_question.as_dict.return_value = {"mock_question_data": "mock_value"}
#     mock_node.display_info.return_value = {
#         "q_str": "Enter job name",
#         "next_question_a_type": "open-ended",
#         "is_last": is_last
#     }

#     mocker.patch("app.routes.blueprints.answer_form.get_first_non_preset_node", return_value=mock_node)
#     mocker.patch("app.routes.blueprints.answer_form.is_last_question", return_value=is_last)
...
#     assert result == {"q_str": "Enter job name", "next_question_a_type": "open-ended", "is_last": is_last}
