...
from tests.helpers import generate_node, generate_question, build_test_ll, build_test_session
...
def test_get_first_a_type_returns_a_type_value(test_client: FlaskClient, mocker:MockerFixture):
    ...
    build_test_ll(test_client, [head, second, third])
...
class TestDisplayInfo():
    ...
    def test_get_next_question_returns_question_display_info(self, test_client: FlaskClient, mocker:MockerFixture, next_is_last, next_is_addon):        
        nodes = []
        # add nodes to ll
        ...
        build_test_session(test_client, sess_vars)
    ...
    def test_get_prev_question_returns_question_display_info(self, test_client: FlaskClient, mocker:MockerFixture, prev_is_first, prev_is_addon):
        nodes = []
        # add nodes to ll
